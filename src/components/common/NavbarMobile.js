...
const NavbarMobile = ({ loading, subLinks, matchRoute, isOpen, setIsOpen }) => {
    ...
    return (
        <>
            ...
            <div className='cursor-pointer z-1 text-yellow-50'
                onClick={handleClick}
            >
            ...
            {/* Links */}
            <div
                className={`fixed top-14 left-0 ${isOpen ? "w-[30vh]" : "w-0"
                    } h-screen ${location.pathname !== "/" ? "bg-richblack-800" : "bg-[#000c23]"
                        ...
                        <>
                            <div className="overflow-hidden">
                                ...
                                >
                                    ...
                                    <FaAngleDown
                                        className={`${isDashboardOpen ? "rotate-180" : "rotate-0"
