    ...
    return (
        <div className=''>
            ...
            <section className='border-b border-richblack-700'>
                <div className='mx-auto flex-11/12 max-w-maxContent flex-col justify-between gap-10 text-richblack-500'>
                ...
                <div className='mx-auto flex w-11/12 max-w-maxContent flex-col justify-between gap-10 text-richblack-900'>
                    ...
                    <div className='flex flex-col items-center gap-10 lg:flex-row justify-between'>
                        ...
                        <div className='my-24 flex lg:w-[50%] flex-col gap-10'>
                            <RedText text={"Our Founding Story"} />
                            <p className=' text-richblack-300 text-base font-medium lg:w-[95%] '>
                                Our e-learning platform was born out of a shared vision and passion for transforming education. It all began with a group of educators, technologists,
                            ...
                            <p className='  text-richblack-300 text-base font-medium lg:w-[95%]'>
                                ...
                                the limitations and challenges of traditional education systems.
                                We believed that education should not be confined to the
                                walls of a classroom or restricted by geographical boundaries.
                        ...
                        <div>
                            <img src={FoundingStory} alt="FoundigStorry" loading='lazy'
                                className='shadow-[0_0_30px_0] shadow-[#7b2cbf] ' />
                        </div>
                    </div>
                    ...
                    <div className='flex flex-col items-center lg:gap-10 lg:flex-row justify-between'>
                        ...
                        <div className='my-24 flex lg:w-[40%] flex-col gap-10'>
                            ...
                            <p className=' text-richblack-300 text-base font-medium lg:w-[95%] '>
                                ...
                                create an e-learning platform that would revolutionize the way
                                people learn. Our team of dedicated experts worked tirelessly to
                        ...
                        <div className='my-24 flex lg:w-[40%] flex-col gap-10'>
                            ...
                            <p className=' text-richblack-300 text-base font-medium lg:w-[95%] '>
                                ...
                                environment of sharing and dialogue, and we foster this spirit of collaboration through forums, live sessions,
            ...
            {/* section 5 */}
            <section className='w-11/12 max-w-maxContent mx-auto flex flex-col items-center justify-between gap-5 mb-5' >
                <LearningGrid />
                <ContactForm />
            </section >
